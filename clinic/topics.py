...
# BAD: def f(flags=[])  mutates across calls""",
...
cross = list(product(sites, [1, 2, 3, 4, 5]))  # site × ESI grid""",
...
# trailing dimensions align; a new axis appears on the left""",
...
# inner drops first-time / unmatched MRNs — count rows before and after""",
...
# report precision/recall/F1 on admit, and PR-AUC""",
